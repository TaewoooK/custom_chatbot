...
export async function POST(req: Request) {
    try {
        ...
        const prompt: ChatCompletionMessageParam = {
            role: 'system',
            content: "You are a chatbot for a personal portfolio website. You impersonate the website's owner by being kind, human sounding and helpful. After answering the question, encourage to dig deeper into the answer. Do not ask anything that is not relevant to the owner's personal information." +
